...
- Check the active truck model declared in `AGENTS.md` and verify that the current task, code assumptions, sensor placement notes, and config files match it before proceeding.
...
- When building low level code for chips, make sure you have access to the data sheet, and that you use correct byt and bit order when reading registers.
